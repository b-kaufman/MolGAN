...
from models.gan_no_val import GraphGANValueless
...
def train_feed_dict(i, steps, epoch, epochs, min_epochs, model, optimizer, batch_dim):
    # returns what to pass into model at each step
...
# model
model = GraphGANValueless(data.vertexes,
                          data.bond_num_types,
                          data.atom_num_types,
                          z_dim,
...
# optimizer
optimizer = GraphGANValuelessOptimizer(model, learning_rate=1e-3, feature_matching=False)
